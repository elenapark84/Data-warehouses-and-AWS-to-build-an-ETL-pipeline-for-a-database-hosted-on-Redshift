"""Define you SQL statements that are imported into the create_table.py and etl.py
"""
...
# STAGING TABLES
# first Load from JSON Arrays Using a JSONPaths file (LOG_JSONPATH),
# and then setting COMPUPDATE, STATUPDATE to speed up COPY
